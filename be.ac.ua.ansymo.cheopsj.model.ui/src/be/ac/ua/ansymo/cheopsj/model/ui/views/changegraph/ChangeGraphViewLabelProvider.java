...
public class ChangeGraphViewLabelProvider extends LabelProvider implements IConnectionStyleProvider {
	...
	public String getText(Object element) {
		...
		if (element instanceof FamixAssociation) {
			return ((FamixAssociation) element).getStringRepresentation();
		}
